...
#start_index = pd.datetime(2018,5)
#append_data = start_index.strftime('%m %Y')
#fd = open('BangaloreDelhi.csv','a')
#fd.write(append_data)
#fd.close()
...
for t in range(len(test)):
	model = ARIMA(history, order=(a,b,c), freq='5T')
